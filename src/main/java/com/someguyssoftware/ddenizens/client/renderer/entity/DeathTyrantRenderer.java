...
import com.someguyssoftware.ddenizens.client.renderer.entity.layer.DeathTyrantEyeLayer;
import com.someguyssoftware.ddenizens.entity.monster.Beholder;
import com.someguyssoftware.ddenizens.entity.monster.DeathTyrant;
...
public class DeathTyrantRenderer<T extends DeathTyrant> extends MobRenderer<T, DeathTyrantModel<T>> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(DD.MODID, "textures/entity/death_tyrant.png");
