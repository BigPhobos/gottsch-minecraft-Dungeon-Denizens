...
public class DeathTyrantEggItem extends DDEggItem {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flag) {
        ...
        LangUtil.appendAdvancedHoverText(tooltip, tt -> {
            ...
            tooltip.add(Component.translatable(LangUtil.tooltip("stats.daylight"), Component.translatable(LangUtil.tooltip("boolean.no"))));
            ...
            tooltip.add(Component.literal("- Every 4 minutes, has a 40% chance to summon a Daemon."));
        });
    }
}
