 ...
 *
 */
public class ShadowlordEggItem extends DDEggItem {

    public ShadowlordEggItem(Supplier<? extends EntityType<? extends Mob>> type, int backgroundColor, int highlightColor, Properties props) {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flag) {
        ...
        LangUtil.appendAdvancedHoverText(tooltip, tt -> {
            ...
            tooltip.add(Component.translatable(LangUtil.tooltip("stats.health"), 50));
            ...
            tooltip.add(Component.literal("- Aura of Blindness surrounds a Shadowlord."));
            tooltip.add(Component.literal("- Melee hit inflicts Poison."));
            tooltip.add(Component.literal("- Can cast Harm spell."));
            tooltip.add(Component.literal("- Can summon multiple minions at once including Shadows and Ghouls."));
            tooltip.add(Component.literal("- Has a chance to summon a Daemon."));
