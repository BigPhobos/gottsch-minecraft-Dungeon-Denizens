 ...
 */
public class WingedSkeletonEggItem extends DDEggItem {

    public WingedSkeletonEggItem(Supplier<? extends EntityType<? extends Mob>> type, int backgroundColor, int highlightColor, Properties props) {
