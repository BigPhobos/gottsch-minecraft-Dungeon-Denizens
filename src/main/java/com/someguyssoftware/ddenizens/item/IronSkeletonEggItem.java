 ...
 */
public class IronSkeletonEggItem extends DDEggItem {

    public IronSkeletonEggItem(Supplier<? extends EntityType<? extends Mob>> type, int backgroundColor, int highlightColor, Properties props) {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flag) {
        ...
        LangUtil.appendAdvancedHoverText(tooltip, tt -> {
            ...
            tooltip.add(Component.translatable(LangUtil.tooltip("stats.damage"), "6-10"));
            ...
            tooltip.add(Component.literal("- Very strong. Doesn't burn in sunlight."));
        });
    }
}
