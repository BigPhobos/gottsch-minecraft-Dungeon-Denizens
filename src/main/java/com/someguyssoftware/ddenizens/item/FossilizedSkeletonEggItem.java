 ...
 */
public class FossilizedSkeletonEggItem extends DDEggItem {

    public FossilizedSkeletonEggItem(Supplier<? extends EntityType<? extends Mob>> type, int backgroundColor, int highlightColor, Properties props) {
    ...
    public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flag) {
        ...
        LangUtil.appendAdvancedHoverText(tooltip, tt -> {
            ...
            tooltip.add(Component.literal("- Stronger than vanilla skeleton."));
        });
    }
}
